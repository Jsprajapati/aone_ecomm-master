...
class ControllerCliInstall extends Controller {
	...
	public function install($argv) {
		...
		if (!is_file(DIR_OPENCART . 'config.php')) {
			$error .= 'config.php does not exist. You need to rename config.php to config.php!';
			...
			$error .= 'admin/config.php does not exist. You need to rename admin/config.php to admin/config.php!';
